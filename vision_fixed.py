...
UART_ENABLED = False  # ZMIENIONE NA False DO TESTÓW BEZ UART
...
# POPRAWKA: Teraz zgodne z kolejnością kamer
...
if TERMINAL_OUTPUT: 
    ...
    print("LEWA kamera = index 2 (lewa strona robota)")
    print("PRAWA kamera = index 0 (prawa strona robota)")
    print("=" * 60)

# POPRAWKA: Teraz zgodne z kalibracją
...
while True:
    ...
    # 1. REKTYFIKACJA (z poprawnymi mapami)
    ...
    if GUI_ENABLED:
        ...
        # Etykieta kamery
        cv2.putText(rectL, "LEWA (index 2)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(rectR, "PRAWA (index 0)", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
