...
# 3. Otwórz kamery (ZGODNIE Z vision.py)
...
print("✓ Kamery otwarte (LEWA=index2, PRAWA=index0)")
...
# Dodaj etykiety
cv2.putText(combined, "LEWA (index 2)", (10, 30), 
            cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
cv2.putText(combined, "PRAWA (index 0)", (650, 30), 
